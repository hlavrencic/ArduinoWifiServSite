class NotificationBar {
  ...
  constructor(ko, apiService, blocker, wifiStatusViewModel) {
    this.ko = ko;
    ...
    this.wifi = ko.observable(wifiStatusViewModel);
  }

  init() {
    this.wifi().autoSync(true);
  }
...
define([
  ...
  "apiService",
  "mods/blocker",
  "mods/wifiStatusViewModel"
], (ko, viewModel, apiService, blocker, wifiStatusViewModel) => {
  ko.components.register("notification-bar", {
    viewModel: {
      createViewModel: (params, componentInfo) => {
        let model = new NotificationBar(
          ko,
          apiService,
          blocker,
          wifiStatusViewModel
