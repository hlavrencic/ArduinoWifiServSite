...
var wifiServ = new WifiservDummy();
wifiServ.subscribe(console.log);
var viewModel = new ViewModel(ko);
let viewModelHistory = new ViewModelHistory();
viewModelHistory.subscribe(viewModel);
let viewModelStatus = new ViewModelStatus();
viewModelStatus.subscribe(viewModel);

var binder = new Binder(wifiServ, viewModel);
